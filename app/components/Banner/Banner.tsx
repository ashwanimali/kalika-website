      ...
      <div className="mx-auto max-w-7xl pt-16 sm:pt-20 pb-20 banner-image">
        <div className="text-center">
          <h1 className="text-4xl font-semibold text-navyblue sm:text-5xl  lg:text-7xl md:4px lh-96">
            Build Smart Digital Solutions <br /> with Kalika Innovations.
          </h1>
          <p className="mt-6 text-lg leading-8 text-bluegray">
            Kalika Innovations helps businesses grow through powerful web apps, mobile apps,
            and custom software solutions.<br />
            We design, develop, and deliver technology that works for your future .
          </p>
        </div>
