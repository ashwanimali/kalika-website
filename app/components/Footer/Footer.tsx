      ...
      <div className="mx-auto max-w-2xl pt-4 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="my-12 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4 md:col-span-4 lg:col-span-4">
            ...
            <div className="flex gap-2 mt-10 items-center">
              ...
              />
              <a
                href="mailto:info@kalikainnovations.in"
                className="text-base font-normal text-offwhite hover:underline"
              >
                info@kalikainnovations.in
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="py-10 lg:flex items-center justify-between border-t border-t-bordertop">
          <h4 className="text-offwhite text-sm text-center lg:text-start font-normal">
            ...
            <Link href="https://kalikainnovations.in" target="_blank" className="hover:underline">
              Kalika Innovations Pvt. Ltd.
            </Link>
          </h4>
